...
class Formulario {
    ...
    function __construct($formulario, $id = null)
    {
        ...
        if (array_key_exists($formulario, $formularios)) {
            ...
            $this->token = md5(SECRET.$this->id.session_id());           
    ...
    public function validar(){
        ...
        if(!array_key_exists('csrf-token', $_POST) || $_POST['csrf-token'] != md5(SECRET.$this->id.session_id())){
            $this->errores['csrf-token'] = 'Acceso no permitido';
        }else{
